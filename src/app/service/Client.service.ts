...
export class ClientService {
  ...
  // ✅ Returns null on 404 (no active subscription) – removes console error
  ...
  renewAbonnement(dureeMois: number, prixUnitaire: number, nbDevices: number) {
    return this.http.post<AbonnementDTO>(`${this.clientPortalUrl}/abonnement/renew`, { dureeMois, prixUnitaire, nbDevices });
  }
